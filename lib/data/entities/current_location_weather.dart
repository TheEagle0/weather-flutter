class CurrentLocationWeather {
  ...
  CurrentLocationWeather({this.location, this.current, this.forecast});

  CurrentLocationWeather.fromJson(Map<String, dynamic> json) {
    location = json['location'] != null
        ? new Loc.fromJson(json['location'])
        : null;
    current =
...
class Day {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mdoubleemp_c'] = this.mintempC;
